...
- Baixe o arquivo Conversor_unidades.py.
...
2. Digite o número correspondente à categoria desejada (ex: 1 para Comprimento).
3. No sub-menu, digite a sigla da unidade de origem (ex: mm, lb, hp).
